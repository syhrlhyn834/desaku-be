...
INSERT INTO `gambar_galeri` (`uuid`, `description`, `url`) VALUES
	...
	('3243cd5d-a377-4239-8233-5849f044086b', 'Kerja Bakti Kereta Wush makaksjakjsaklshakjshaksja', 'http://api.desaku.muhichsan.com/storage/1715489819.jpeg'),
	('93870671-149d-4e94-ada7-937af5683f07', 'Kerja Bakti Kereta Wush Makanya Rel Kereta Api', 'http://api.desaku.muhichsan.com/storage/1715489819.jpeg');
...
INSERT INTO `header` (`uuid`, `no_telp`, `email`, `logo`, `site_name`, `description`) VALUES
	('1', '0895417205060', 'emaildesaku@kertamulya.desa.id', 'http://api.desaku.muhichsan.com/storage/1716810915.png', 'Desa Kertamulya', 'Provinsi Jawa Barat');
